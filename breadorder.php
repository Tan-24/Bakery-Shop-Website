...
<div class="row">
  ...
  <br>
   <div style="width:90%; background-color:white; border-style:inset; border-width:1px; border-radius: 10px; margin-left: 5%;">
    <center>
     <form action="breadorderprocess.php" method="POST">
   <br>
      <fieldset><br>
    ...
    <fieldset>  <br>
     ...
     <fieldset><br>
      <legend>Order Details</legend>
        ...
        <?php
            $sql="select peices from breads where name='$type'";
            ...
            echo "<input type='text1' name='pieces' value='$pieces' />";
          ?>
        <br><br>
        ...
        <label>Price:</label>
        <?php
            $sql="select price from breads where name='$type'";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) 
            {
            // output data of each row
